/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/jenkins/sdlc/workspace/rsdk-release-x86_64/LIBC/newlib/SDKTYPE/asdk/SDKVER/6/source/gcc-6/gcc/config/arm/arm.md'.  */
