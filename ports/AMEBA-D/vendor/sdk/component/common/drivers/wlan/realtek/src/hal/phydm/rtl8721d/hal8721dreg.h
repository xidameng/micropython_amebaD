 ...
 * 
 *****************************************************************************/
#ifndef __INC_HAL8721DREG_H
#define __INC_HAL8721DREG_H
...
#define REG_MCUFWDL_8721D				0x0080
...
#define REG_TDECTRL1_8721D				0x0228
...
#define REG_AMPDU_MAX_LENGTH_8721D	0x0458
...
#define REG_ANNTENA_SELECT_8721D	0x0764
...
//----------------------------------------------------------------------------
//       8721 IMR/ISR bits						(offset 0xB0,  8bits)
//----------------------------------------------------------------------------
#if 0
#define	IMR_WL_FTINT_MSK_8721D                BIT31       //The interrupt mask from WL page 1 interrupt source		
#define	IMR_P2P_RFOFF_INT_MSK_8721D           BIT9        //P2P NoA RF off time indication interrupt mask
#define	IMR_P2P_RFON_INT_MSK_8721D            BIT8        //P2P NoA RF on time indication interrupt mask
#define	IMR_PSTIMER_MSK_8721D                 BIT6        //Enable PSTimer interrupt source
#define	IMR_TIMEOUT1_MSK_8721D                BIT5        //Enable Timer1 interrupt source
#define	IMR_TIMEOUT0_MSK_8721D                BIT4        //Enable Timer0 interrupt source
#define	IMR_MTI_BCNIVLEAR_INT_MSK_8721D       BIT1        //Enable MTI_BCNIVLEAR _INT
#define	IMR_BCNERLY_MSK_8721D                 BIT0        //This interrupt is issued at the time set by DRVERLYINT register before TBTT time.
#endif


#define	IMR_MSK_CPWM2	           		BIT25
#define	IMR_MSK_CPWM	            	BIT24
#define	IMR_FOVW_MSK_8721D	            BIT23        //"Rx packet buffer OverflowSet this bit to one when Rx packet buffer write pointer hits read pointer. "
#define	IMR_TXBCN0ERR_8721D				BIT20		// Transmit Beacon0 Error	
#define	IMR_TXBCN0OK_8721D				BIT19		// Transmit Beacon0 OK

#define	IMR_TXFOVW_MSK_8721D	        BIT18        //"Transmit packet buffer Overflow.This bit is set to 1 when one or more of the hardware transmit queues is full"

#define	IMR_TSF_BIT32_TOGGLE_MSK_V1_8721D     BIT17       //Enable TSF_BIT32_TOGGLE interrupt source

#define	IMR_CTWEndINT_MSK_8721D	        BIT13        //This bit masks the CTWindow End interrupt.

#define	IMR_BCNDMA9_MSK_8721D	        BIT9       //When BCNDMA interval arrives before TBTT9,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA8_MSK_8721D	        BIT8       //When BCNDMA interval arrives before TBTT8,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA7_MSK_8721D	        BIT7       //When BCNDMA interval arrives before TBTT7,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA6_MSK_8721D	        BIT6       //When BCNDMA interval arrives before TBTT6,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA5_MSK_8721D	        BIT5       //When BCNDMA interval arrives before TBTT5, 
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA4_MSK_8721D	        BIT4       //When BCNDMA interval arrives before TBTT4,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA3_MSK_8721D	        BIT3       //When BCNDMA interval arrives before TBTT3,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA2_MSK_8721D	        BIT2       //When BCNDMA interval arrives before TBTT2, 
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA1_MSK_8721D	        BIT1        //When BCNDMA interval arrives before TBTT1, 
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA0_MSK_8721D	        BIT0        //When BCNDMA interval arrives before TBTT0, 
                                                    //this interrupt informs MCU to prepare related beacon tasks.


#if 0
//----------------------------------------------------------------------------
//       8721 IMR/ISR bits						(offset 0x134,  8bits)
//----------------------------------------------------------------------------
#define	IMR_SOUND_DONE_MSK_8721D        BIT30       //Be a beamformer, this interrupt is issued at the time after sounding finish
#define	IMR_TRY_DONE_MSK_8721D          BIT29       //When TRY_FINISH is deasserted, this interrupt is issued to inform MCU
#define	IMR_TXRPT_CNT_FULL_MSK_8721D    BIT28
#define	IMR_WLACTOFF_INT_EN_8721D       BIT27
#define	IMR_WLACTON_INT_EN_8721D        BIT26
#define	IMR_TXPKTIN_INT_EN_8721D        BIT25	
#define	IMR_RX_UMD0_EN_8721D            BIT22
#define	IMR_RX_UMD1_EN_8721D            BIT21
#define	IMR_RX_BMD0_EN_8721D            BIT20
#define	IMR_RX_BMD1_EN_8721D            BIT19
#define	IMR_BCN_RX_INT_EN_8721D         BIT18
#define	IMR_TBTTINT_MSK_8721D           BIT17

#define	IMR_STBY_MSK_8721D	            BIT7        //Lower Power Standby Interrupt mask
#define	IMR_RXDONE_MSK_8721D	        BIT3        //Rx Packet done for 8051
#define	IMR_ERRORHDL_MSK_8721D	        BIT2        //FWHW/ TXDMA/ RXDMA/ WMAC error status interrupt
#define	IMR_TXCCX_MSK_FW_8721D	        BIT1        //CCX PKT TX Report Interrupt
#define	IMR_TXCLOSE_MSK_8721D	        BIT0        //TX Finish (Ack/BA process Finish) Interrupt.

#endif

//----------------------------------------------------------------------------
//       8721 IMR/ISR bits						(offset 0x13C,  8bits)
//----------------------------------------------------------------------------
#define	IMR_TXBCN1ERR_8721D				BIT15		// Transmit Beacon1 Error	
#define	IMR_TXBCN1OK_8721D				BIT14		// Transmit Beacon1 OK

//----------------------------------------------------------------------------
//       8721 IMR/ISR bits						(offset 0x3EC,  8bits)
//----------------------------------------------------------------------------
#define	IMR_BCNDERR7_8721D				BIT31		// Beacon Queue DMA Error
#define	IMR_BCNDERR6_8721D				BIT30		// Beacon Queue DMA Error
#define	IMR_BCNDERR5_8721D				BIT29		// Beacon Queue DMA Error
#define	IMR_BCNDERR4_8721D				BIT28		// Beacon Queue DMA Error
#define	IMR_BCNDERR3_8721D				BIT27		// Beacon Queue DMA Error
#define	IMR_BCNDERR2_8721D				BIT26		// Beacon Queue DMA Error
#define	IMR_BCNDERR1_8721D				BIT25		// Beacon Queue DMA Error
#define	IMR_BCNDERR0_8721D				BIT24		// Beacon Queue DMA Error
#define	IMR_BCNDMAOK7_8721D				BIT23		// Beacon DMA OK Interrupt 7
#define	IMR_BCNDMAOK6_8721D				BIT22		// Beacon DMA OK Interrupt 6
#define	IMR_BCNDMAOK5_8721D				BIT21		// Beacon DMA OK Interrupt 5
#define	IMR_BCNDMAOK4_8721D				BIT20		// Beacon DMA OK Interrupt 4
#define	IMR_BCNDMAOK3_8721D				BIT19		// Beacon DMA OK Interrupt 3
#define	IMR_BCNDMAOK2_8721D				BIT18		// Beacon DMA OK Interrupt 2
#define	IMR_BCNDMAOK1_8721D				BIT17		// Beacon DMA OK Interrupt 1
#define	IMR_BCNDMAOK0_8721D				BIT16		// Beacon DMA OK Interrupt 0
#define	IMR_H7DOK_8721D					BIT15		// High Queue DMA OK Interrup 7
#define	IMR_H6DOK_8721D					BIT14		// High Queue DMA OK Interrup 6
#define	IMR_H5DOK_8721D					BIT13		// High Queue DMA OK Interrup 5
#define	IMR_H4DOK_8721D					BIT12		// High Queue DMA OK Interrup 4
#define	IMR_H3DOK_8721D					BIT11		// High Queue DMA OK Interrup 3
#define	IMR_H2DOK_8721D					BIT10		// High Queue DMA OK Interrup 2
#define	IMR_H1DOK_8721D					BIT9		// High Queue DMA OK Interrup 1
#define	IMR_H0DOK_8721D					BIT8		// High Queue DMA OK Interrup 1
#define	IMR_MGNTDOK_8721D				BIT6			// Management Queue DMA OK	
#define	IMR_BKDOK_8721D                 BIT5			// AC_BK DMA OK		
#define	IMR_BEDOK_8721D                 BIT4			// AC_BE DMA OK	
#define	IMR_VIDOK_8721D                 BIT3			// AC_VI DMA OK		
#define	IMR_VODOK_8721D                 BIT2			// AC_VO DMA OK	
#define	IMR_RDU_8721D                   BIT1			// Rx Descriptor Unavailable	
#define	IMR_ROK_8721D                   BIT0			// Receive DMA OK
...
*/
//----------------------------------------------------------------------------
//		 8721 (TXPAUSE) transmission pause 	(Offset 0x522, 8 bits)
//----------------------------------------------------------------------------
/*
...
//----------------------------------------------------------------------------
//       8721 (RCR) Receive Configuration Register	(Offset 0x608, 32 bits)
//----------------------------------------------------------------------------
/*
...
//----------------------------------------------------------------------------
//       8721 CAM Config Setting (offset 0x680, 1 byte)
//----------------------------------------------------------------------------      	       		
/*
...
//----------------------------------------------------------------------------
//       8721 REG_BCN_PSR_RPT (Beacon Parser Report Register)	(Offset 0x6A8, 32 bits)
//---------------------------------------------------------------------------- 
...
*/
#endif // #ifndef __INC_HAL8721DREG_H
